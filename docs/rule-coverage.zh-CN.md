...
- **Context Budget Gate**：`CONTEXT_BUDGET_001`、`CONTEXT_BUDGET_002`、`CONTEXT_BUDGET_003`
- **Capability Reuse Rule**：`CAPABILITY_REUSE_001`、`CAPABILITY_REUSE_002`、`CAPABILITY_REUSE_003`
